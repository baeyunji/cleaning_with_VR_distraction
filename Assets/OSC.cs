...
/// - An address string for the device on the board you?e dealing with.
...
/// corresponding structures are used ?UsbPacket and UdpPacket.  Once you?e created 
/// a packet, you can simply call its Send() method, with the OscMessage you? like to send.  
...
/// send an OscMessage with the address of the device you? like to read, but omit 
